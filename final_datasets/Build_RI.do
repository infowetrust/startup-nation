...
keep dataid entityname incdate incyear charter is_DE jurisdiction country zip5 addrstate city address is_corp shorname

keep if inlist(jurisdiction,"DE","RI")
compress
rename zip5 zipcode
rename addrstate state
drop if is_DE & state != "RI"
save RI.dta,replace
